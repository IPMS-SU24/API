...
{
    public class ReviewBorrowIoTComponentsValidator : AbstractValidator<UpdateIoTQuantityRequest>
    {
        public ReviewBorrowIoTComponentsValidator(IIoTDataService iotDataService, IHttpContextAccessor context)
        {
