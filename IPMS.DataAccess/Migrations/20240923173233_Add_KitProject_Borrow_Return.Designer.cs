...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.BasicIoTDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("BasicIoTDevice", (string)null);
                });
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IoTKit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.KitDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("KitDevice", (string)null);
                });

            modelBuilder.Entity("IPMS.DataAccess.Models.KitProject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("KitProject", (string)null);
                });
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.Semester", b =>
                {
                    ...
                    b.Property<bool>("IsMultipleTopic")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.KitDevice", b =>
                {
                    b.HasOne("IPMS.DataAccess.Models.BasicIoTDevice", "Device")
                        .WithMany("Kits")
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IPMS.DataAccess.Models.IoTKit", "Kit")
                        .WithMany("Devices")
                        .HasForeignKey("KitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.KitProject", b =>
                {
                    b.HasOne("IPMS.DataAccess.Models.Student", "Borrower")
                        .WithMany("Borrowed")
                    ...
                    b.HasOne("IPMS.DataAccess.Models.Student", "Returner")
                        .WithMany("Returned")
