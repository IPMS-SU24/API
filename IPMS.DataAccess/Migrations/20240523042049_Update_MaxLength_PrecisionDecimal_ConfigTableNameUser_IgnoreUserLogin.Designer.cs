...
namespace IPMS.DataAccess.Migrations
{
    ...
    [Migration("20240523042049_Update_MaxLength_PrecisionDecimal_ConfigTableNameUser_IgnoreUserLogin")]
    partial class Update_MaxLength_PrecisionDecimal_ConfigTableNameUser_IgnoreUserLogin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSUserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSUserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSRole", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>");

                    b.HasDiscriminator().HasValue("IPMSRole");
                });
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSUser", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("IPMSUser");
                });
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSRoleClaim", b =>
                {
                    b.HasOne("IPMS.DataAccess.Models.IPMSRole", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("IPMS.DataAccess.Models.IPMSUserClaim", b =>
                {
                    b.HasOne("IPMS.DataAccess.Models.IPMSUser", "User")
                        .WithMany("Claims")
